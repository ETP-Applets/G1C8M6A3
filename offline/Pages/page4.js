...
const page4 = ({
  ...
  const getFeedbackMessage = () => {
    ...
    if (isCorrect === true && data.correctFeedbackArea) {
      ...
      return /*#__PURE__*/React.createElement(React.Fragment, null, data.correctFeedbackArea.text1, /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("br", null), data.correctFeedbackArea.text2, " ", verb, " ", difference, ' ', data.correctFeedbackArea.extra, " ", extraAnimalName, ".", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("br", null), data.correctFeedbackArea.text3, " ", moreNameForSentence, ' ', data.correctFeedbackArea.text4, " ", lessNameForSentence, ' ', data.correctFeedbackArea.text5, " ", difference, ".");
    }
    ...
    if (isCorrect === false && data.wrongFeedbackArea) {
      return /*#__PURE__*/React.createElement(React.Fragment, null, data.wrongFeedbackArea.text1, " ", largerName, " ", data.wrongFeedbackArea.and, " ", smallerName, ".", /*#__PURE__*/React.createElement("br", null), " ", /*#__PURE__*/React.createElement("strong", {
        className: "text-[#F9A942]"
      }, data.wrongFeedbackArea.text3, " ", largerName, " = ", data.wrongFeedbackArea.text4, " ", largerName, " - ", data.wrongFeedbackArea.text4, " ", smallerName), ".");
    }
    return null;
  };
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("style", null, `
    ...
    component2: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      ...
      key: index,
      className: `row-outline-image ${shouldHighlightExtras && number1 > number2 && index >= minCount ? 'extra' : ''}`
      ...
      key: index,
      className: `row-outline-image ${shouldHighlightExtras && number2 > number1 && index >= minCount ? 'extra' : ''}`
    }, /*#__PURE__*/React.createElement("img", {
      src: animalImage2,
      alt: selectedName2
    })))))), /*#__PURE__*/React.createElement("div", {
