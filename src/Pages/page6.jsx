...
const page6 = ({ 
  ...
  const getFeedbackMessage = () => {
    if (!feedbackText) {
      return (
        <>
          {data.feedbackArea.text1} {selectedName1} {data.feedbackArea.and} {selectedName2}, <strong className="text-[#F9A942]">{data.feedbackArea.text1Bold}</strong> {data.feedbackArea.text11}
        </>
      )
    }
    ...
    if (isCorrect && feedbackText.text4) {
      ...
      return (
        <>
          {feedbackText.text1} <br />
          <br /> {feedbackText.text2} {lesserNumber} {lesserName}{' '}
          {feedbackText.and} {largerNumber} {largerName}. {feedbackText.text3}{' '}
          <strong className="text-[#F9A942]">
            {lesserName} {feedbackText.text4}{' '}
          </strong>{' '}
          {feedbackText.text5} {largerName}.
        </>
      )
    }
    ...
    return (
      <>
        {feedbackText.text1} <br />
        <br /> {feedbackText.text2} {lesserNumber} {lesserName}{' '}
        {feedbackText.and} {largerNumber} {largerName}. <br />
        <br />
        {feedbackText.text3}
      </>
    )
